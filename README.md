...
In this lab, you will walk through two new features supported by Internet Explorer 10 that were introduced in ECMAScript 5: strict mode and Typed arrays. You will also see how to use some of the new Document Object Model (DOM) improvements, like advanced hit-testing APIs, media query listeners, and pointer and gesture events.
...
If you find any issues with this hands-on lab that you can't fix, feel free to report them in the [issues](https://github.com/Microsoft-Web/HOL-DOMFeaturesAndECMAScript5/issues) section of this repository.